...
import { handRails } from './ConfigurationData/Handrails';

const HandRails = () => {
  return (
    <div className="flex flex-col">
      <small>
        LEVELe-102 | HANDRAIL SELECTION: Handrails are optional and may be
        specified for elevator back walls and/or side walls. Six standard series
        offer a wide range of design and material possibilities. Begin by
        selecting a series from the options below.
      </small>
